...
static const command step[] = {
	...
	{ X,          5 },	{ NOTHING,  50 }, //open menu
	{ A,          5 },	{ NOTHING,  100 }, 
	{ A,          5 },	{ NOTHING,  50 }, //you want to teleport here?
	{ A,          5 },	{ NOTHING,  100 }, //sure!
	// walk to daycare and get an egg
	{ DOWN,      50 },	{ NOTHING,    5 }, //walk down to daycare
	{ LEFT,       5 },	{ NOTHING,    5 }, //a little bit left
	{ A,          5 },	{ NOTHING,  55 }, //start talk
 	{ A,          5 },	{ NOTHING,  120 }, //yes I do
	{ A,          5 },	{ NOTHING,  90 }, //you got it
	{ A,          5 },	{ NOTHING,  60 }, //Put egg on your team
	{ A,          5 },	{ NOTHING,  80 }, //please select the slot!
	...
	{ A,          5 },	{ NOTHING, 	125 },
	{ B,          5 },	{ NOTHING, 	 10 },*/
	{ PLUS,       5 },	{ NOTHING,  50 }, //get off the bike
	// repeat
};
...
int main(void) {
	...
	{
		HID_Task();
		// main USB management task. Not imported
		USB_USBTask();
	}
}
